  ...
  return (
    <div className='boxTodo_container'>
      <div className='boxTodo_content'>
          {isEditing ?(
            <div>
                <input className='input_header' type='text' value={currentTitle} onChange={(e)=>setCurrentTitle(e.target.value)} autoFocus/>
                <div style={{display:'flex', gap:'6px',position:'absolute'}}>
                        <div style={{display:'flex', gap:'5px'}}>
                            <FontAwesomeIcon onClick={() =>setIsEditing(false)}  size='1x' icon={faXmark}  style={{color:'white'}}/>
                            <FontAwesomeIcon onClick={() =>setIsEditing(false)} size='1x' icon={faCheck}  style={{color:'white'}}/>
                        </div>
                </div>
            </div>
          ):(
            <div>
                ...
                <FontAwesomeIcon size='1x' className='edit_icon' onClick={handleTitleClick} icon={faEdit}  style={{color:'white'}}/>
            </div>
          )}

...
import { Draggable, DraggableProvided, DraggableStateSnapshot } from 'react-beautiful-dnd'; // Import Draggable from react-beautiful-dnd

const BoxTodo = ({ Id, title, category, dueDate, estimate, importance, index,isDragging }) => {

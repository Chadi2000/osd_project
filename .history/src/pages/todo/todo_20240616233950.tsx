        ...
        <div>
          <div style={{display:'flex'}}>
            <div style={{position:'absolute', top: isQuoteVisible? '168px':'100px', left:'34px'}}>
              ...
              <div style={{position:'absolute',left:'34px', top:'250px', display:'flex', flexDirection:'column', gap:'30px'}}>
                <BoxTodo title='Prepare the assay' category='Education'
                dueDate='12/12/2022' estimate='6 hours' importance='High'
                />
                <BoxTodo title='Prepare the assay' category='Education'
                dueDate='12/12/2022' estimate='6 hours' importance='Medium'
                />
              </div>
            </div>

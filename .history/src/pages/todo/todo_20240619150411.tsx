        ...
        <div className='background'>
          ...
          <div>
            <div style={{ display: 'flex' }}>
              ...
              >
                <div style={{ borderRadius: '10px', height: isQuoteVisible?'1300px':'1368px', width:'418px',position: 'absolute', left: '34px', top: isQuoteVisible ? '226px' : '158px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div>
              ...
              <SortableContext
                ...
                strategy={verticalListSortingStrategy}
              >
                <div style={{ borderRadius: '10px', height: isQuoteVisible?'1300px':'1368px', width: '418px', position: 'absolute', left: '487px', top: isQuoteVisible ? '226px' : '158px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div>
              ...
              <SortableContext
                ...
                strategy={verticalListSortingStrategy}
              >
                <div style={{ borderRadius: '10px', height: isQuoteVisible?'1300px':'1368px', width:'418px',position: 'absolute', left: '939px', top: isQuoteVisible ? '226px' : '158px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
...
const EmptyPlaceholder = () => {
  return <div className="empty-placeholder">Drop items here</div>;
};

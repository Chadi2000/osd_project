        ...
        <div className='add_item-container' style={{display: addItem? 'flex' : 'none',justifyContent:'flex-start',
         flexDirection:'column',alignItems:'flex-start', position:'absolute', top: isQuoteVisible ? '136px': '68px',right: '118px'}}>
          ...
          <div className='add_item-row'>
            ...
            <input type='text' className='input_title' placeholder='Enter category' onChange={(e) => handleCategoryChange(e.target.value)} /><br></br>
          </div>
          <div className='add_item-row'>
            <label className='item-label'>date</label>
            <input type='date' className='input_title' placeholder='Enter date' onChange={(e) => handleDueDateChange(e.target.value)} /><br></br>
          </div>
          <div className='add_item-row'>
            <label className='item-label'>estimate</label>
            <div className='input_title'>
            <input style={{width:'40px'}} type='number' className='input_estimate' placeholder='Enter estimate' value={estimatedValue} onChange={handleValueChange} /><br></br>

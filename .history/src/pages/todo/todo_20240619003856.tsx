          ...
          <div className='background'>
            <div>
              ...
              <div>
                ...
                <div style={{ border: '1px solid red', height:'1000px', width:'418px', position: 'absolute', left: '487px', top: isQuoteVisible ? '226px' : '158px', display: 'flex', flexDirection: 'column', gap: '20px' }}>

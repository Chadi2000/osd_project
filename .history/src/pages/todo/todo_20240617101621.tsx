        ...
        <div>
          <div style={{display:'flex'}}>
            <div style={{position:'absolute', top: isQuoteVisible? '168px':'100px', left:'34px'}}>
              ...
              <div style={{position:'absolute',left:'34px', top: isQuoteVisible? '226px' : '158px', display:'flex', flexDirection:'column', gap:'20px'}}>
          ...
          <div>
            <div style={{position:'absolute', top: isQuoteVisible? '168px':'100px', left:'485px'}}>
             ...
             <div style={{position:'absolute',left:'487px', top: isQuoteVisible? '226px' : '158px', display:'flex', flexDirection:'column', gap:'20px'}}>
          ...
          <div>
            <div style={{position:'absolute', top: isQuoteVisible? '168px':'100px', left:'937px'}}>
             ...
             <div style={{position:'absolute',left:'939px', top: isQuoteVisible? '226px' : '158px', display:'flex', flexDirection:'column', gap:'20px'}}>

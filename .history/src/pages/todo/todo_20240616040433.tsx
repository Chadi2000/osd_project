  ...
  return (
    <div className='app__todo'>
      ...
      <div className='background'>
        <div className='add_item-container' style={{display: addItem? 'flex' : 'none',justifyContent:'flex-start', flexDirection:'column',alignItems:'center', position:'absolute', top: isQuoteVisible ? '136px': '68px',right: '118px'}}>
          <div style={{display:'flex', justifyContent:'flex-start', textAlign:'start'}}>Add New Item</div>
          <div >
            <label>Title</label>

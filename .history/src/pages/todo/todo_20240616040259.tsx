  ...
  return (
    <div className='app__todo'>
      ...
      <div className='background'>
        <div className='add_item-container' style={{display: addItem? 'flex' : 'none', flexDirection:'column',alignItems:'center', position:'absolute', top: isQuoteVisible ? '136px': '68px',right: '118px'}}>

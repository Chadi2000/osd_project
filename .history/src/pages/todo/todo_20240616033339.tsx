  ...
  return (
    <div className='app__todo'>
      ...
      <div className='background'>
        <div style={{display: addItem? 'flex' : 'none', flexDirection:'column',alignItems:'center', position:'absolute', top:'200px',}}>
          <div>Add New Item</div>
          <div>
            <label>Title</label>
            <input type='text' id='txtName' placeholder='Enter title' onChange={(e) => handleTitleChange(e.target.value)} />
          </div>
          <div>

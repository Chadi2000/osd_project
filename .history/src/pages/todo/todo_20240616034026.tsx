  ...
  return (
    <div className='app__todo'>
      ...
      <div className='background'>
        <div style={{display: addItem? 'flex' : 'none', flexDirection:'column',alignItems:'center', position:'absolute', top:'200px',right:'50px'}}>
          ...
          <div>
            <label>date</label>
            <input type='date' id='txtAddress' placeholder='Enter date' onChange={(e) => handleDueDateChange(e.target.value)} /><br></br>
          </div>
          <div>

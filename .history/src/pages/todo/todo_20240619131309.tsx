        ...
        <div className='background'>
          ...
          <div>
            <div style={{ display: 'flex' }}>
              ...
              >
                <div style={{ border: '2px solid', borderRadius: '10px', height: '1300px', width:'418px',position: 'absolute', left: '34px', top: isQuoteVisible ? '226px' : '158px', display: 'flex', flexDirection: 'column', gap: '20px' }}>

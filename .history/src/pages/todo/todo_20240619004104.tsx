          ...
          <div className='background'>
            <div>
              <div style={{ display: 'flex' }}>
                ...
                <div style={{ border: '2px solid', height:'1000px',position: 'absolute', left: '34px', top: isQuoteVisible ? '226px' : '158px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  {getDataByStatus('Todo')}
                </div>
              </div>
              <div>
                ...
                <div style={{ border: '2px solid', height:'1000px', width:'418px', position: 'absolute', left: '487px', top: isQuoteVisible ? '226px' : '158px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
              ...
              <div>
                ...
                <div style={{ border: '2px solid', height:'1000px', position: 'absolute', left: '939px', top: isQuoteVisible ? '226px' : '158px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
